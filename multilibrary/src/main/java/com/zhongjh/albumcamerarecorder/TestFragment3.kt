...
class TestFragment3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_soundrecording_zjh, container, false)
    }
...
//        // 先通过标签形式查找
//        val matissFragment = childFragmentManager.findFragmentByTag("3")
//        // 如果不存在，则重新创建并添加，如果已经存在就不用处理了，因为FragmentStateAdapter已经帮我们处理了
//        matissFragment ?: let {
//            val newMatissFragment = TestFragment3()
